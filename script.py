...
# import cv2
# from mss import mss
#sys.path.append(r"E:\Users\%username%\rifef\ffmpeg-n6.0-latest-win64-gpl-shared-6.0\bin")
...
vs.core.std.LoadPlugin(r"E:\Users\%username%\rifef\bas-r1\win64\BestAudioSource.dll")
...
# cc.bas
audio_file = r"C:\Users\%username%\Documents\dawd\lofi1\lofi\Mixdown\v3\00015v3.mp3"
